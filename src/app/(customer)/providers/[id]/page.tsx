...
//     return (
//       <div
//         className={`${workSans.className} max-w-3xl mx-auto px-6 py-10 text-red-600`}
//       >
...
//     latitude != null &&
//     longitude != null &&
//     !isWithinDeliveryRange(latitude, longitude, provider);
...
//               <div>
//                 <h1
//                   className={`${fraunces.className} text-3xl font-semibold mb-1`}
//                 >
...
//                   </p>
//                 )}
//                 <p className="text-sm text-[#2B2013]/50 mt-1">
//                   {provider.address}
//                 </p>
//               </div>
...
//               )}
//               {outOfRange && (
//                 <p className="text-sm text-[#B23A2E] font-medium mt-2">
...
//               <h2
//                 className={`${fraunces.className} text-lg font-semibold mb-3 text-[#2B2013]/80`}
//               >
...
//                             disabled={inOtherCart || outOfRange}
//                             className={`btn-3d btn-3d-primary text-white text-sm font-medium px-4 py-1.5 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
//                               added
//                                 ? "added-pop bg-[#55713C]"
//                                 : "bg-[#B23A2E] hover:bg-[#963025]"
//                             }`}
//                           >
//                             {added ? "Added ✓" : "Add"}
//                           </button>
...
//                           Adding will clear your current cart from another
//                           provider.
//                         </p>
//                       )}
//                     </div>
...
export default function ProviderMenuPage() {
  ...
  const { latitude, longitude, permissionDenied } = useLocationStore();
  ...
  // Pickup-only providers don't need location at all — the customer
  // is travelling to them, not the other way around.
  const needsLocation = provider?.deliveryAvailable === true;
  const locationKnown = latitude != null && longitude != null;
  ...
  const missingLocation = needsLocation && !locationKnown;
  const orderingBlocked = missingLocation || outOfRange;
  ...
  return (
    <div className={`${workSans.className} max-w-3xl mx-auto px-6 py-8 pb-28`}>
      <style jsx global>{`
        ...
        .btn-3d-primary { box-shadow: 0 3px 0 #8f2a20; }
      ...
      {needsLocation && missingLocation && (
        <div className="rounded-2xl border border-[#B23A2E]/25 bg-[#B23A2E]/8 px-4 py-3 mb-4">
          <p className="text-sm text-[#B23A2E] font-medium">
            {permissionDenied
              ? "We can't deliver your food without your location. Please enable location access, or set it manually below, to continue."
              : "Please share your location so we can check if this kitchen delivers to you."}
          </p>
        </div>
      )}
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex flex-col items-end gap-2 shrink-0">
                          ...
                          <button
                            onClick={() => handleAddToCart(item, provider!)}
                            disabled={inOtherCart || orderingBlocked}
                            className={`btn-3d btn-3d-primary text-white text-sm font-medium px-4 py-1.5 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                              added
                                ? "added-pop bg-[#55713C]"
                                : "bg-[#B23A2E] hover:bg-[#963025]"
