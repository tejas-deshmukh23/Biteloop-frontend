      ...
      >
        ...
        >
          ...
          >
            ...
            <path d="M125 240 Q125 300 240 305 Q355 300 355 240 Z" fill="#9BA3A8" />
            ...
            <path d="M290 230 L330 130" stroke="#8B5E34" strokeWidth="7" strokeLinecap="round" />
            <ellipse cx="333" cy="120" rx="12" ry="16" fill="#8B5E34" />

            <path className="steam steam-1" d="M210 190 C195 160, 220 145, 205 110" stroke="#F7F1E1" strokeWidth="5" strokeLinecap="round" fill="none" />
            <path className="steam steam-2" d="M250 185 C235 155, 262 138, 248 100" stroke="#F7F1E1" strokeWidth="5" strokeLinecap="round" fill="none" />
            <path className="steam steam-3" d="M180 195 C168 170, 188 158, 178 130" stroke="#F7F1E1" strokeWidth="4" strokeLinecap="round" fill="none" />
            ...
            <g transform="translate(390, 250)">
              ...
              <path d="M25 -10 Q60 -35 95 -10" stroke="#2B2013" strokeWidth="6" strokeLinecap="round" fill="none" />
            </g>
    ...
    <div className={`${workSans.className} bg-[#FBF4EC] text-[#2B2013] min-h-screen overflow-x-hidden`}>
      <style jsx global>{`
        @media (prefers-reduced-motion: no-preference) {
          .ambient-tilt-outer { animation: ambientTilt 8s ease-in-out infinite; }
          .scene-bob { animation: sceneBob 4.5s ease-in-out infinite; }
          .steam { animation: steamRise 2.6s ease-in-out infinite; transform-origin: bottom; }
          .steam-2 { animation-delay: 0.5s; }
          .steam-3 { animation-delay: 1s; }
          .flame { animation: flameFlicker 1.1s ease-in-out infinite; transform-origin: bottom center; }
          .flame-inner { animation-delay: 0.2s; }
          .live-ping { animation: livePing 2s cubic-bezier(0, 0, 0.2, 1) infinite; }
          .hero-enter { animation: heroEnter 0.7s ease-out both; }
        }
        ...
        /* ── 3D buttons ──────────────────────────────
           A solid "edge" shadow (not blurred) simulates
           a raised surface; it shrinks and the button
           drops down on press, like a physical key. */
        .btn-3d {
          position: relative;
          transform: translateY(0);
        }
        ...
        .btn-3d-primary {
          box-shadow: 0 4px 0 #8f2a20, 0 10px 20px -6px rgba(178, 58, 46, 0.45);
        }
        .btn-3d-primary:hover {
          box-shadow: 0 5px 0 #8f2a20, 0 14px 24px -6px rgba(178, 58, 46, 0.5);
        }
        .btn-3d-primary:active {
          box-shadow: 0 1px 0 #8f2a20, 0 4px 10px -4px rgba(178, 58, 46, 0.4);
        }

        .btn-3d-gold {
          box-shadow: 0 4px 0 #a97a1f, 0 10px 20px -6px rgba(216, 155, 44, 0.45);
        }
        .btn-3d-gold:hover {
          box-shadow: 0 5px 0 #a97a1f, 0 14px 24px -6px rgba(216, 155, 44, 0.5);
        }
        .btn-3d-gold:active {
          box-shadow: 0 1px 0 #a97a1f, 0 4px 10px -4px rgba(216, 155, 44, 0.4);
        }

        .btn-3d-outline {
          background: #fffaf3;
          box-shadow: 0 4px 0 rgba(43, 32, 19, 0.16), 0 8px 16px -8px rgba(43, 32, 19, 0.25);
        }
        .btn-3d-outline:hover {
          box-shadow: 0 5px 0 rgba(43, 32, 19, 0.2), 0 10px 18px -8px rgba(43, 32, 19, 0.28);
        }
        .btn-3d-outline:active {
          box-shadow: 0 1px 0 rgba(43, 32, 19, 0.16), 0 3px 8px -4px rgba(43, 32, 19, 0.2);
        }
      `}</style>

      {/* Nav — floating card: curved corners, border, shadow underneath */}
      ...
      {/* Hero — three separate blocks (intro, image, actions) so mobile
          can reorder them independently of the desktop two-column grid */}
      <section className="max-w-6xl mx-auto px-6 pt-10 pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div
            className="order-3 lg:order-3 lg:col-start-1 lg:row-start-2 hero-enter mt-2 lg:mt-8 flex flex-wrap gap-4"
